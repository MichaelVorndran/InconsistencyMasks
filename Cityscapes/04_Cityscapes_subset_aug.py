...
from functions import train_multiclass, create_augment_images_and_masks_multiclass
...
create_augment_images_and_masks_multiclass(paths.CITYSCAPES_TRAIN_LABELED_IMAGES_DIR, 
                                             paths.CITYSCAPES_TRAIN_LABELED_MASKS_DIR, 
                                             paths.CITYSCAPES_TRAIN_LABELED_AUG_MAIN_DIR,
                                             brightness_range_alpha=(0.6, 1.4), brightness_range_beta=(-15, 15), max_blur=1, max_noise=15)


num_imgs = len(os.listdir(paths.CITYSCAPES_TRAIN_LABELED_AUG_IMAGES_DIR))
...
with tf.device('/gpu:0'):
    ...
    for runid in range(1,4):
        ...
        for i in range(0,10):
            ...
            mPA_val, mPA_test, mPA_train_unlabeled, mIoU_val, mIoU_test, mIoU_train_unlabeled = train_multiclass(paths.CITYSCAPES_TRAIN_LABELED_AUG_IMAGES_DIR, 
