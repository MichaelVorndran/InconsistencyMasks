...
subset_names_val_test = ['val', 'test']


split_and_resize_dataset(paths.CITYSCAPES_TRAIN_FULL_IMAGES_DIR, 
                         paths.CITYSCAPES_TRAIN_FULL_MASKS_DIR,  
                         paths.CITYSCAPES_BASE_DIR, 
                         subset_names_train, 
                         0.9,
                         SEED)

split_and_resize_dataset(paths.CITYSCAPES_ORG_VAL_TEST_IMAGES_DIR, 
                         paths.CITYSCAPES_ORG_VAL_TEST_MASKS_DIR, 
                         paths.CITYSCAPES_BASE_DIR, 
                         subset_names_val_test, 
                         0.5,
                         SEED)
