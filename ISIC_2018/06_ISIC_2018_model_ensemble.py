...
from functions import train_ISIC_2018, create_pseudo_labels_model_ensemble_ISIC_2018, dice_loss
        ...
        for n in range(2,5):
            ...
            for gen in range(0,5):
                ...
                if gen == 0:
                    ...
                    for j in range(1,n+1):
                        best_model_filepaths_h5.append(os.path.join(paths.ISIC_2018_MODEL_DIR, f'ISIC_2018_{approach}_{runid}_n{n}_gen{gen-1}_topK_{j}.h5'))
                ...
                create_pseudo_labels_model_ensemble_ISIC_2018(best_models, paths.ISIC_2018_VAL_IMAGES_DIR, val_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, True)
                create_pseudo_labels_model_ensemble_ISIC_2018(best_models, paths.ISIC_2018_TEST_IMAGES_DIR, test_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, True)
                create_pseudo_labels_model_ensemble_ISIC_2018(best_models, paths.ISIC_2018_TRAIN_UNLABELED_IMAGES_DIR, train_unlabeled_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, True)
