...
from functions import train_ISIC_2018, create_pseudo_labels_input_ensemble_ISIC_2018, dice_loss
...
USE_N_RND_TRANSFORMATIONS = bool(config['ISIC_2018']['USE_N_RND_TRANSFORMATIONS'])
    ...
    for runid in range(1,4):
        ...
        for n in range(3,8,2):
            ...
            for gen in range(0,5):
                ...
                modelname = f'ISIC_2018_{approach}_{runid}_n{n}_gen{gen}'
                ...
                if gen == 0:
                    ...
                    best_model_filepath_h5 = os.path.join(paths.ISIC_2018_MODEL_DIR, f'ISIC_2018_{approach}_{runid}_n{n}_gen{gen-1}_topK_1.h5')

                best_model = tf.keras.models.load_model(best_model_filepath_h5, custom_objects={'dice_loss': dice_loss})
                
                create_pseudo_labels_input_ensemble_ISIC_2018(best_model, paths.ISIC_2018_VAL_IMAGES_DIR, val_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, n, True, USE_N_RND_TRANSFORMATIONS)
                create_pseudo_labels_input_ensemble_ISIC_2018(best_model, paths.ISIC_2018_TEST_IMAGES_DIR, test_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, n, True, USE_N_RND_TRANSFORMATIONS)
                create_pseudo_labels_input_ensemble_ISIC_2018(best_model, paths.ISIC_2018_TRAIN_UNLABELED_IMAGES_DIR, train_unlabeled_pseudo_label_dir, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS, n, True, USE_N_RND_TRANSFORMATIONS)
                ...
                for imagename in tqdm(os.listdir(paths.ISIC_2018_TRAIN_LABELED_IMAGES_DIR)):
                    ...
                    shutil.copy(os.path.join(paths.ISIC_2018_TRAIN_LABELED_MASKS_DIR, imagename), os.path.join(train_unlabeled_pseudo_label_dir_gt, imagename))
