...
with tf.device('/gpu:0'):
    ...
    for runid in range(1,4):
        ...
        for i in range(0,10):
            ...
            mIoU_val, mIoU_test, mIoU_train_unlabeled, dice_score_val, dice_score_test, dice_score_train_unlabeled = train_ISIC_2018(paths.ISIC_2018_TRAIN_LABELED_IMAGES_DIR, 
