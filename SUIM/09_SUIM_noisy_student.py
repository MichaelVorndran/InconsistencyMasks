...
from functions import train_multiclass, create_pseudo_labels_noisy_student_multiclass
...
with tf.device('/gpu:0'):
    ...
    for runid in range(1,4):
        ...
        for gen in range(0,5):
            ...
            modelname = f'SUIM_{approach}_{runid}_gen{gen}'
            ...
            if gen == 0:
                ...
                best_model_filepath_h5 = os.path.join(paths.SUIM_MODEL_DIR, f'SUIM_{approach}_{runid}_gen{gen-1}_topK_1.h5')
            ...
            create_pseudo_labels_noisy_student_multiclass(best_model, 
