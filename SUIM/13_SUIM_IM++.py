...
with tf.device('/gpu:0'):
    ...
    for runid in range(1,4):
        ...
        if train_new_evalnet == True:
            ...
            main_output_evalnet_im_dir_train = os.path.join(paths.SUIM_BASE_DIR, 'evalnet_im', f'run_{runid}', 'train')
            main_output_evalnet_im_dir_val = os.path.join(paths.SUIM_BASE_DIR, 'evalnet_im', f'run_{runid}', 'val')
            ...
            for i in range(0,5):
                ...
                modelname_evalnet_im = f'SUIM_evalnet_miou_im_{runid}_{i}'
        ...
        for n in range(2,3):
            ...
            for gen in range(0,5):
                ...
                for j in range(1,n+1):
                    best_evalnet_filepaths_h5.append(os.path.join(paths.SUIM_MODEL_DIR, f'SUIM_evalnet_miou_im_{runid}_topK_{j}.h5'))
