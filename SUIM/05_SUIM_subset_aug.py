...
create_augment_images_and_masks_multiclass(paths.SUIM_TRAIN_LABELED_IMAGES_DIR, 
                                             paths.SUIM_TRAIN_LABELED_MASKS_DIR, 
                                             paths.SUIM_TRAIN_LABELED_AUG_MAIN_DIR)


num_imgs = len(os.listdir(paths.SUIM_TRAIN_LABELED_AUG_IMAGES_DIR))
...
with tf.device('/gpu:0'):
    ...
    for runid in range(1,4):
        ...
        for i in range(0,10):
            ...
            mPA_val, mPA_test, mPA_train_unlabeled, mIoU_val, mIoU_test, mIoU_train_unlabeled = train_multiclass(paths.SUIM_TRAIN_LABELED_AUG_IMAGES_DIR, 
