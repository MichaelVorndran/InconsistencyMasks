...
from functions import train_hela, create_augment_images_and_masks_hela
...
create_augment_images_and_masks_hela(paths.HELA_TRAIN_LABELED_DIR, 
                                     paths.HELA_TRAIN_LABELED_AUG_DIR)


num_imgs = len(os.listdir(paths.HELA_TRAIN_LABELED_AUG_BRIGHTFIELD_DIR))
    ...
    for runid in range(1,4):
        ...
        for i in range(0,10):
            ...
            mIoU_val, mIoU_ad_val, mcce_val, mIoU_test, mIoU_ad_test, mcce_test, mIoU_unlabeled, mIoU_ad_unlabeled, mcce_unlabeled = train_hela(
                                                                                                            paths.HELA_TRAIN_LABELED_AUG_BRIGHTFIELD_DIR, 
